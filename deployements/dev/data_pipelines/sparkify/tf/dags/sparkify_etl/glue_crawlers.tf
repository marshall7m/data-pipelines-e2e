...
resource "aws_glue_crawler" "raw" {
  ...
  s3_target {
    path = "s3://${var.private_bucket_name}/data/raw/staging_events/"
  }

  s3_target {
    path = "s3://${var.private_bucket_name}/data/raw/staging_songs/"
  }
...
resource "aws_glue_crawler" "parquet" {
  ...
  s3_target {
    path = "s3://${var.private_bucket_name}/data/parquet/year={year}/month={month}/day={day}/"
  }
